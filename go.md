...
2. Die Sitzungsleitung wird von der, die ZaPF organisierenden, Fachschaft
   ...
   Bis zur Wahl der Sitzungsleitung fungieren von der ausrichtenden Fachschaft beauftragte Personen als
   Sitzungsleitung.
3. Zu Beginn der Sitzung wird eine Protokollführung, bestehend aus einer
   oder mehreren Personen, gewählt.
   Das Protokoll der Sitzung wird spätestens zur folgenden ZaPF geeignet zugänglich gemacht.
...
2. Anträge sind mindestens zwei Stunden vor Beginn des Plenums in Textform
   bei der die ZaPF ausrichtenden Fachschaft einzureichen.
   Die antragstellenden Personen haben dafür zu sorgen, dass dies rechtzeitig geschieht.
...
4. Anträge, die nach der entsprechenden Frist eingereicht werden, sind Initiativanträge
   ...
   der Tagesordnung". % Vereinheitlichung Anführungszeichen
...
1. *Geschäftsordnungsanträge* (GO-Anträge) werden durch ein deutliches Zeichen
   ...
   Sie sind spätestens vor der nächsten Wortmeldung bzw. Abstimmung zu
   behandeln und abzustimmen.
2. Es ist nur eine Rede durch die antragstellende Person und eine Gegenrede
   erlaubt, dabei ist eine inhaltliche einer formellen Gegenrede vorzuziehen.
   Eine darüber hinausgehende Diskussion von GO-Anträgen findet nicht statt.
   Ein Antwortrecht außerhalb der Redeliste für die antragstellende Person besteht nicht.
...
4. Geschäftsordnungsanträge sind folgende Anträge:
   - zur Änderung der Tagesordnung, % zurs Streichen
   ...
   - zur Anzweiflung einer Abstimmung (ohne Gegenrede, ohne Abstimmung) % Was passiert dann?
   ...
   - zur Neuwahl der Sitzungsleitung unter Benennung einer oder mehrerer gegenkandidierenden Personen
   - zur Neuwahl der Protokollführung unter Benennung einer oder mehrerer gegenkandidierenden Personen
   - zur Einholung eines Meinungsbildes im Plenum
   - zum Vorschlag eines Verfahrens
   - zur *Freiwilligen Dokumentation des Abstimmungsverhaltens* (kurze Bedenkzeit, bei
...
Dieser Abschnitt bestimmt den Ablauf von Abstimmungen und Meinungsbilder des Plenums
sowie die Wahlmodi für Personenwahlen. Vom üblichen Modus für Personenwahlen
abweichende Bestimmungen werden in einem eigenen Unterabschnitt bestimmt, die
...
*zwanzig Fachschaften* im Plenum anwesend sind.
...
Wahlen aus. Für geheime Abstimmungen und Wahlen wird von der Sitzungsleitung
ein Wahlausschuss bestimmt. Hierbei darf kein Mitglied des Wahlausschusses selbst zur
Wahl stehen.

## Abstimmungen und Meinungsbilder

1. Es werden Abstimmungen und *Meinungsbilder* unterschieden. Meinungsbilder
   sind informelle Abstimmungen um die Meinung der im Plenum anwesenden Personen
   einzuholen, während Abstimmungen über die Annahme oder Ablehnung von
   Anträgen entscheiden.
...
2. Beschlüsse sind nach außen zu tragende *Resolutionen*, die zwingend an eine
   ...
   adressiert sein müssen, *Anschlüsse*, die sich Beschlüssel anderer Gruppierungen
   (z.B. Resolutionen anderer Bundesfachschaftentagungen) anschließen und zwingend
   an diese addressiert sind, sowie an weitere natürliche oder juristische Personen
   oder Personengruppen addressiert sein können, *Positionspapiere*,
   die an niemanden adressiert sind, sowie ZaPF-interne *Selbstverpflichtungen*
   und Aufträge an den StAPF.
3. Bei Meinungsbildern stimmberechtigt ist jede teilnehmende Person der ZaPF.
4. Bei Abstimmungen stimmberechtigt ist jede mit mindestens einer teilnehmenden
   Person im Plenum anwesende Fachschaft.
...
5. Ein Antrag gilt als angenommen, wenn die Anzahl der Ja-Stimmen größer
   ...
   Falls in dieser erneuten Abstimmung wiederum die Zahl der Enthaltungen
   überwiegt, gilt der Antrag als abgelehnt.
   Die Stimmabgabe ist geeignet, z.B. durch deutliches Handheben, kenntlich zu
   machen, eine geheime Abstimmung auf Papier im Sinne des GO-Antrags auf "geheime Abstimmung" kann beantragt werden.
   ...
   und verfällt andernfalls.
   Stimmrechtsübertragung ist nicht möglich.
   Anträge sind positiv zu formulieren.
6. Änderungsanträge ändern den Wortlaut eines Antrages, aber nicht ihr Wesen.
   ...
   wird der Hauptantrag in der geänderten Fassung zur Beschlussfassung vorgelegt.
...
8. Bei konkurrierenden Anträgen ist die Beschlussfassung wie folgt durchzuführen:
   ...
   zuerst abzustimmen.
   Wird dieser angenommen, so sind die Übrigen gegenstandslos.
   Lässt sich der weitergehende Antrag nicht feststellen, so bestimmt sich die
   ...
   Lässt sich diese nicht feststellen, entscheidet die Sitzungsleitung.
...
1. Das *passive Wahlrecht* für Personenwahlen besitzen alle natürlichen Personen.
2. Personenwahlen sind grundsätzlich geheim durchzuführen.
   Abweichend davon, dürfen Sitzungsleitung und Protokollführung akklamiert werden.
3. Es werden die Wahlmodi für normale Personenwahlen und die Wahl der
   Vertrauenspersonen im Anfangsplenum unterschieden.
4. Stimmberechtigt für normale Personenwahlen ist jede mit mindestens einer
   teilnehmenden Person im Plenum anwesende Fachschaft.
   Jede Fachschaft hat eine Stimme; wie sie abstimmt, ist innerhalb der
   jeweiligen Fachschaft zu regeln.
   Den Fachschaften ist Zeit zur Beratung zu gewähren.
5. Die normalen Personenwahlen sind wie folgt durchzuführen:
   ...
   - Dem Plenum ist die Möglichkeit zu geben, unter Ausschluss der
     Kandidierenden über diese zu diskutieren. Diese Diskussion wird nicht protokolliert.
   - Eine kandidierende Person gilt als gewählt, wenn sie mehr Ja-Stimmen
     als Nein-Stimmen, *mindestens jedoch elf Ja-Stimmen* auf sich vereint
     und die Wahl annimmt.
   - Enthaltungen sind möglich und wirken wie nicht oder ungültig abgegebene
     Stimmen.
   - Sollten mehr Kandidierende gewählt werden, als Ämter zur Verfügung stehen,
     werden sie nach Anzahl der Ja-Stimmen absteigend sortiert besetzt.
6. Abwahlen sind auch bei Abwesenheit der betroffenen Person möglich und
   ...
   Der Antrag auf Abwahl ist bis spätestens 15 Uhr am Vortag gegenüber
   der ausrichtenden Fachschaft anzukündigen.
   Die betroffene Person ist nach Möglichkeit anzuhören.

## Vertrauenspersonen

1. Im Anfangsplenum werden bis zu sechs Vertrauenspersonen gewählt. Das aktive
...
2. Die Wahl der Vertrauenspersonen erfolgt per Wahl durch
   ...
   Bewerbungen müssen bis spätestens zu Beginn des Anfangsplenums
   in Textform an eine, bis spätestens zwei Wochen vor Beginn der
   ZaPF durch die ausrichtende Fachschaft bekanntzugebende, E-Mail-Adresse erfolgen.
3. Eine Personaldebatte findet nicht statt, die Kandidierenden dürfen sich
   jedoch dem Plenum vorstellen.
4. Wahl durch Zustimmung läuft wie folgt ab:
   - Jede wahlberechtigte Person erhält einen Stimmzettel.
   ...
   - Im ersten Durchgang werden alle Stimmen ausgezählt und die Person
     ...
     Daraufhin werden alle Stimmzettel, die der ersten gewählten Person
     eine Ja-Stimme gegeben haben, von den übrigen Stimmzetteln getrennt.
   - In den darauf folgenden Durchgängen gilt immer die Person mit den
     meisten Stimmen in den verbliebenen Stimmzetteln der Gruppe der gewählten
     Personen als gewählt und die Stimmzettel mit einer Stimme von den übrigen Stimmzetteln
     getrennt. Dies wird so lange wiederholt bis alle Plätze besetzt sind
     oder keine Stimmzettel mehr übrig sind.
   - Bei Stimmgleichheit entscheidet die Anzahl der Stimmen aus der
     ersten Runde. Bei Gleichstand entscheidet das Los.
   - Sollten noch nicht alle Plätze besetzt sein, obwohl keine
     Stimmzettel mehr verblieben sind, werden die restlichen Plätze
     nach Anzahl der Stimmen in der ersten Runde besetzt.
...
8. Darüber hinaus bestimmt die austragende Fachschaft zwei Vertrauenspersonen
   aus ihrer Fachschaft. Diese werden nicht vom Plenum bestätigt.
9. Weiterhin sind die beiden das Awarenessgremium bildenden Personen auch
   Vertrauenspersonen. Diese werden nicht vom Plenum bestätigt.
